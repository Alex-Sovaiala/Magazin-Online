...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Placa video MSI GeForce® GTX 1050 Ti GAMING X, 4GB GDDR5, 128-bit</title>
  </head>
  <script>
	var slideIndex = 1;
...
<div id="wrapperhead">
  ...
  <br><br><br>
    ...
    <div id="wrapper">
    <h1 style="font-size:30px;font-weight:bold;padding-left:1.5em;padding-right:2em;padding-top:1em;" >Placa video MSI GeForce® GTX 1050 Ti GAMING X, 4GB GDDR5, 128-bit</h1>
  ...
  <div class="mySlides fade">
    ...
    <img src="imaginiVid/produs2/1.jpg" style="width:100%">

  </div>

  <div class="mySlides fade">
    <div class="numbertext">2 / 3</div>
    <img src="imaginiVid/produs2/2.jpg" style="width:100%">

  </div>

  <div class="mySlides fade">
    <div class="numbertext">3 / 3</div>
    <img src="imaginiVid/produs2/3.jpg" style="width:100%">
...
<br>
	...
	<h4 style="font-size:20px;margin-left:2.5em;">ZERO FROZR - Ramai nedetectat</h4><br>
	<p style="margin-left:3.5em;">Introduse pentru prima
	oara in 2008 de MSI, tehnologia Zero Frozr si-a facut
	renumele si este acum standardul in industrie printre
	placile video. Elimina zgomotul ventilatoarelor
	oprindu-le in situatii de incarcare slaba a
	continutului. Acest lucru inseamna ca te poti
	concentra pe gaming fara sa auzi zgomotul rotirii
	ventilatoarelor.</p><br>

	<h4 style="font-size:20px;margin-left:2.5em;">Ventilatoare TORX 2.0 - Munca de echipa pentru putere mai mare</h4><br>
	<p style="margin-left:3.5em;">Noua tehnologie MSI
	TORX 2.0 a ventilatoarelor foloseste puterea muncii
	de echipa pentru a permite TWIN FROZR VI sa atinga
	noi nivele de racire.
	Designul ventilatoarelor TORX 2.0 genereaza cu
	22% mai multa presiune a aerului pentru performanta
	silentioasa suprema in lupta cu temperatura.</p><br>
      ...
      <td class="text-left">GeForce GTX 1050Ti</td>
      </tr>
      <tr>
      ...
      <td class="text-left">2560 x 1600</td>
      </tr>
      <tr>
