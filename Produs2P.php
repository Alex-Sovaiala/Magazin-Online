...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Procesor AMD Ryzen 5 2600, 3.9GHz, 19MB Socket AM4, Wraith Stealth cooler</title>
  </head>
  <script>
	var slideIndex = 1;
...
<div id="wrapperhead">
  ...
  <br><br><br>
    ...
    <div id="wrapper">
    <h1 style="font-size:30px;font-weight:bold;padding-left:1.5em;padding-right:2em;padding-top:1em;" >Procesor AMD Ryzen 5 2600, 3.9GHz, 19MB Socket AM4, Wraith Stealth cooler</h1>
  ...
  <div class="mySlides fade">
    ...
    <img src="imaginiP/produs2/1.jpg" style="width:100%">

  </div>

  <div class="mySlides fade">
    <div class="numbertext">2 / 3</div>
    <img src="imaginiP/produs2/2.jpg" style="width:100%">
...
<br>
	...
	<h4 style="margin-left:2em;font-size:23px;">Precision Boost 2</h4>
	<p style="margin-left:3em;">
	...
	<p style="margin-left:3em;">
      ...
      <td class="text-left">3400</td>
      </tr>
      <tr>
      <td class="text-left">Memorie Cache</td>
      <td class="text-left">19MB</td>
      </tr>
      <tr>
      <td class="text-left">TurboBoost pana la</td>
      <td class="text-left">3900MHZ</td>
      </tr>
      <tr>
      ...
      <td class="text-left">6 Nuclee</td>
      </tr>
      <tr>
