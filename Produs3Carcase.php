...
<div id="wrapperhead">
  ...
  <div class="mySlides fade">
    ...
    <img src="imaginiCarcase/produs3/1.jpg" style="width:100%">

  </div>

  <div class="mySlides fade">
    <div class="numbertext">2 / 3</div>
    <img src="imaginiCarcase/produs3/2.jpg" style="width:100%">

  </div>

  <div class="mySlides fade">
    <div class="numbertext">3 / 3</div>
    <img src="imaginiCarcase/produs3/3.jpg" style="width:100%">
...
<br>
	...
	<br>
      ...
      <td class="text-left">Middle Tower</td>
      </tr>
      <tr>
      <td class="text-left">Numar locase fixe interne</td>
      <td class="text-left">3 x 3.5"<br>1 x 2.5"<br>	3 x 5.25"</td>
      </tr>
      <tr>
      ...
      <td class="text-left">2 x USB2.0 <br> 1 x USB 3.0<br>HD Audio<br>Panou lateral transparent<br>Interior negru<br>2 x Audio jack<br>2 x ventilatoare RED LED incluse<br>Panou frontal transparent<br>Filtru de praf magnetic</td>
      </tr>
      <tr>
      <td class="text-left">Dimensiuni (W x H x D mm)</td>
      <td class="text-left">410 x 175 x 440</td>
      </tr>
	  <tr>
