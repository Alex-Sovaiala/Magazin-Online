...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Televizor LED Smart Philips, 139 cm, 55PUS6703/12, 4K Ultra HD</title>
  </head>
  <script>
	var slideIndex = 1;
...
<div id="wrapperhead">
  ...
  <br><br><br>
    ...
    <div id="wrapper">
    <h1 style="font-size:30px;font-weight:bold;padding-left:1.5em;padding-right:2em;padding-top:1em;" >Televizor LED Smart Philips, 139 cm, 55PUS6703/12, 4K Ultra HD</h1>
  ...
  <div class="mySlides fade">
    ...
    <img src="imaginiTvPhilips/produs2/1.jpg" style="width:100%">

  </div>

  <div class="mySlides fade">
    <div class="numbertext">2 / 6</div>
    <img src="imaginiTvPhilips/produs2/2.jpg" style="width:100%">

  </div>

  <div class="mySlides fade">
    <div class="numbertext">3 / 6</div>
    <img src="imaginiTvPhilips/produs2/3.jpg" style="width:100%">

  </div>
  <div class="mySlides fade">
    <div class="numbertext">4 / 6</div>
    <img src="imaginiTvPhilips/produs2/4.jpg" style="width:100%">

  </div>
  <div class="mySlides fade">
    <div class="numbertext">5 / 6</div>
    <img src="imaginiTvPhilips/produs2/5.jpg" style="width:100%">

  </div>
  <div class="mySlides fade">
    <div class="numbertext">6 / 6</div>
    <img src="imaginiTvPhilips/produs2/6.jpg" style="width:100%">
...
<br>
    ...
    <tr>
      ...
      <td class="text-left">Incredible Surround<br>
Sunet clar<br>
...
Smart Sound</td>
      ...
      <td class="text-left">Micro Dimming<br>
Pixel Precise Ultra HD<br>
Ultra rezolutie<br>
1100 PPI</td>
      </tr>
    <tr>
...
1 x Audio in<Br></td>
    ...
    <tr>
      ...
      <td class="text-left">1244 x 729 x 68 mm</td>
    </tr>
    <tr>
      <td class="text-left">Dimensiuni (W x H x D) cu stand</td>
      <td class="text-left">1244 x 761 x 231 mm</td>
    </tr>
    <tr>
      <td class="text-left">Putere consumata</td>
      <td class="text-left">82 W</td>
    </tr>
    <tr>
...
Video la cerere<br>
Pauza TV<br>
Deschide browser-ul de Internet<br>
