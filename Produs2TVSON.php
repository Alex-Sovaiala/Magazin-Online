...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Televizor LED Smart Samsung, 123 cm, 49NU7102, 4K Ultra HD</title>
  </head>
  <script>
	var slideIndex = 1;
...
<div id="wrapperhead">
  ...
  <br><br><br>
    ...
    <div id="wrapper">
    <h1 style="font-size:30px;font-weight:bold;padding-left:1.5em;padding-right:2em;padding-top:1em;" >Televizor LED Smart Samsung, 123 cm, 49NU7102, 4K Ultra HD</h1>
  ...
  <div class="mySlides fade">
    ...
    <img src="imaginiTvSony/produs2/1.jpg" style="width:100%">

  </div>

  <div class="mySlides fade">
    <div class="numbertext">2 / 3</div>
    <img src="imaginiTvSony/produs2/2.jpg" style="width:100%">

  </div>

  <div class="mySlides fade">
    <div class="numbertext">3 / 3</div>
    <img src="imaginiTvSony/produs2/3.jpg" style="width:100%">

  </div>
  <div class="mySlides fade">
    <div class="numbertext">4 / 8</div>
    <img src="imaginiTvSony/produs2/4.jpg" style="width:100%">

  </div>
  <div class="mySlides fade">
    <div class="numbertext">5 / 8</div>
    <img src="imaginiTvSony/produs2/5.jpg" style="width:100%">

  </div>
  <div class="mySlides fade">
    <div class="numbertext">6 / 8</div>
    <img src="imaginiTvSony/produs2/6.jpg" style="width:100%">

  </div>
  <div class="mySlides fade">
    <div class="numbertext">7 / 8</div>
    <img src="imaginiTvSony/produs2/7.jpg" style="width:100%">

  </div>
  <div class="mySlides fade">
    <div class="numbertext">8 / 8</div>
    <img src="imaginiTvSony/produs2/8.jpg" style="width:100%">
...
<br>
      ...
      <td class="text-left">HDR powered by HDR10+
      </tr>
      <tr>
    ...
    <tr>
      ...
      <td class="text-left">Dolby Digital Plus<Br>2 Channels<br>Multiroom Link</td>
      </tr>
      <tr>
      <tr>
      ...
      <td class="text-left">	Film Mode<Br>
  ...
  Pur Color
    ...
    <tr>
      ...
      <td class="text-left">DVB-T2C / TC</td>
      </tr>
    <tr>
  ...
  Slot CI+</td>
    ...
    <tr>
      ...
      <td class="text-left">1102.8 x 637.8 x 59.7 mm</td>
    </tr>
    <tr>
      <td class="text-left">Dimensiuni (W x H x D) cu stand</td>
      <td class="text-left">	1102.8 x 716.4 x 261.3 mm</td>
    </tr>
    <tr>
      <td class="text-left">Putere consumata</td>
      <td class="text-left">140 W</td>
    </tr>
    <tr>
  ...
  Telecomada</td>
    ...
    <tr>
      ...
      <td class="text-left">EPG<br>
WiFi Direct<br>
Caption (Subtitle)<br>
ConnectShare™ (USB 2.0)<br>
Teletext (TTX) Mega<br>
Instant On<br>
Digital Clean View<br>
ConnectShare™ (HDD)<br>
Auto Channel Search<br>
Mobile to TV - Mirroring, DLNA<br>
