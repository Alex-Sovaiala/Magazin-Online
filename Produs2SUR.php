...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Sursa Inter-Tech SL-500K, 500W</title>
  </head>
  <script>
	var slideIndex = 1;
...
<div id="wrapperhead">
  ...
  <br><br><br>
    ...
    <div id="wrapper">
    <h1 style="font-size:30px;font-weight:bold;padding-left:1.5em;padding-right:2em;padding-top:1em;" >Sursa Inter-Tech SL-500K, 500W</h1>
  ...
  <div class="mySlides fade">
    ...
    <img src="imaginiSur/produs2/1.jpg" style="width:100%">

  </div>

  <div class="mySlides fade">
    <div class="numbertext">2 / 3</div>
    <img src="imaginiSur/produs2/2.jpg" style="width:100%">

  </div>

  <div class="mySlides fade">
    <div class="numbertext">3 / 3</div>
    <img src="imaginiSur/produs2/3.jpg" style="width:100%">
...
<br>
	...
	<br>
      ...
      <td class="text-left"class="table-hover" style="width:600px;">500</td>
      </tr>
	  <tr>
      ...
      <td class="text-left">3 x SATA<br>1 x 20 + 4 pin ATX<br>1 x ATX 4 pin <br>2 x Milex<br>1 x Floppy (4 pin)</td>
      </tr>
      <tr>
      ...
      <td class="text-left">Single rail (30A)</td>
      </tr>
