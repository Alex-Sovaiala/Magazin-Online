...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Placa video GIGABYTE GeForce® GT 710, 2GB DDR3, 64-bit
	</title>
  </head>
  <script>
	var slideIndex = 1;
...
<div id="wrapperhead">
  ...
  <br><br><br>
    ...
    <div id="wrapper">
    <h1 style="font-size:30px;font-weight:bold;padding-left:1.5em;padding-right:2em;padding-top:1em;" >Placa video GIGABYTE GeForce® GT 710, 2GB DDR3, 64-bit
	</h1>
  ...
  <div class="mySlides fade">
    ...
    <img src="imaginiVid/produs3/1.jpg" style="width:100%">

  </div>

  <div class="mySlides fade">
    <div class="numbertext">2 / 3</div>
    <img src="imaginiVid/produs3/2.jpg" style="width:100%">

  </div>

  <div class="mySlides fade">
    <div class="numbertext">3 / 3</div>
    <img src="imaginiVid/produs3/3.jpg" style="width:100%">
