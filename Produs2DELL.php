...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Laptop Dell Inspiron 5570 cu procesor Intel® Core™ i5-8250U pana la 3.40 GHz, Kaby Lake R, 15.6", Full HD, 8GB, 256GB SSD, AMD Radeon 530 4GB, Linux, Silver, Backlit</title>
  </head>
  <script>
	var slideIndex = 1;
...
<div id="wrapperhead">
  ...
  <br><br><br>
    ...
    <div id="wrapper">
    <h1 style="font-size:30px;font-weight:bold;padding-left:1.5em;padding-right:2em;padding-top:1em;" >Laptop Dell Inspiron 5570 cu procesor Intel® Core™ i5-8250U pana la 3.40 GHz, Kaby Lake R, 15.6", Full HD, 8GB, 256GB SSD, AMD Radeon 530 4GB, Linux, Silver, Backlit</h1>
  ...
  <div class="mySlides fade">
    ...
    <img src="imaginiDell/produs2/1.jpg" style="width:100%">

  </div>

  <div class="mySlides fade">
    <div class="numbertext">2 / 3</div>
    <img src="imaginiDell/produs2/2.jpg" style="width:100%">

  </div>

  <div class="mySlides fade">
    <div class="numbertext">3 / 3</div>
    <img src="imaginiDell/produs2/3.jpg" style="width:100%">
...
<br>
      ...
      <td class="text-left">Waves MaxxAudio</td>
	  </tr>
	  <tr>
      ...
      <td class="text-left">2 x USB 3.1<br>1 x USB 2.0<br>1 x Audio Out<br>
	  1 x HDMI<br>1 x USB type C<br>1 x RJ-45
	  </td>
	  </tr>
	  <tr>
      ...
      <td class="text-left">380 x 22.7 x 258 mm</td>
      </tr>
	  <tr>
      ...
      <td class="text-left">Camera web<br>Tastatura iluminata</td>
      </tr>
	  <tr>
