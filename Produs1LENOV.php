...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Laptop Lenovo V130-15IGM cu procesor Intel® Celeron® N4000 pana la 2.60 GHz, 15.6", 4GB, 1TB, Intel® UHD Graphics 600, Free DOS, Iron Grey</title>
  </head>
  <script>
	var slideIndex = 1;
...
<div id="wrapperhead">
  ...
  <br><br><br>
    ...
    <div id="wrapper">
    <h1 style="font-size:30px;font-weight:bold;padding-left:1.5em;padding-right:2em;padding-top:1em;" >Laptop Lenovo V130-15IGM cu procesor Intel® Celeron® N4000 pana la 2.60 GHz, 15.6", 4GB, 1TB, Intel® UHD Graphics 600, Free DOS, Iron Grey</h1>
  ...
  <div class="mySlides fade">
    ...
    <img src="imaginiLenov/produs1/1.jpg" style="width:100%">

  </div>

  <div class="mySlides fade">
    <div class="numbertext">2 / 3</div>
    <img src="imaginiLenov/produs1/2.jpg" style="width:100%">

  </div>

  <div class="mySlides fade">
    <div class="numbertext">3 / 3</div>
    <img src="imaginiLenov/produs1/3.jpg" style="width:100%">
...
<br>
	...
	asiguram ca acesta va rezista.</p>
      ...
      <td class="text-left">Celeron</td>
      </tr>
      <tr>
      <td class="text-left">Model proceos</td>
      <td class="text-left">N4000</td>
      </tr>
      <tr>
      ...
      <td class="text-left">2600 MHz</td>
      </tr>
	  <tr>
      ...
      <td class="text-left">Intel® HD Graphics 600</td>
      </tr>
      <tr>
      ...
      <td class="text-left">1 x USB 3.0<br>1 x USB 2.0<br>1 x Audio Out/Microfon<br>
      ...
      <td class="text-left">Adaptor 45W</td>
      </tr>
	  <tr>
      ...
      <td class="text-left">Camera web<br>TouchPad cu suport pentru gesturi multi atingere<br>Tastatura economica</td>
      </tr>
	  <tr>
