...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Solid-State Drive (SSD) Gigabyte, 120GB, 2.5", SATA III</title>
  </head>
  <script>
	var slideIndex = 1;
...
<div id="wrapperhead">
  ...
  <br><br><br>
    ...
    <div id="wrapper">
    <h1 style="font-size:30px;font-weight:bold;padding-left:1.5em;padding-right:2em;padding-top:1em;" >Solid-State Drive (SSD) Gigabyte, 120GB, 2.5", SATA III</h1>
  ...
  <div class="mySlides fade">
    ...
    <img src="imaginiSsd/produs2/1.jpg" style="width:100%">

  </div>

  <div class="mySlides fade">
    <div class="numbertext">2 / 3</div>
    <img src="imaginiSsd/produs2/2.jpg" style="width:100%">

  </div>

  <div class="mySlides fade">
    <div class="numbertext">3 / 3</div>
    <img src="imaginiSsd/produs2/3.jpg" style="width:100%">
  ...
  <a class="next" onclick="plusSlides(1)">&#10095;</a>
	...
	<h4 style="margin-left:2em;font-size:23px;">Solid-State Drive (SSD) Gigabyte, 120GB, 2.5", SATA 3</h4>
	<p style="margin-left:3em;">
		Fiabilitatea de incredere. SSD-urile
		Gigabyte ofera viteze mari de transfer si o rezistenta
		sporita, MTBF de pana la 2 milioane ore sau 75TB scrisi.
	</p><br>


	<br>
      <div class="table-title" style="margin-right:1em;">
      ...
      <td class="text-left">380</td>
      </tr>
      <tr>
      <td class="text-left">Dimensiuni (W x D x H mm)</td>
      <td class="text-left">100 x 69.85 x7</td>
      </tr>
