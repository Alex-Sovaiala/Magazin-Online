...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Sistem Desktop PC Gaming Acer GX-281 cu procesor AMD RYZEN 5 1600 3.20 GHz, 8GB, 1TB, DVD-RW, nVIDIA GeForce GTX 1050 Ti 4GB, Endless OS, Mouse + Tastatura</title>
  </head>
  <script>
	var slideIndex = 1;
...
<div id="wrapperhead">
  ...
  <br><br><br>
    ...
    <div id="wrapper">
    <h1 style="font-size:30px;font-weight:bold;padding-left:1.5em;padding-right:2em;padding-top:1em;" >Sistem Desktop PC Gaming Acer GX-281 cu procesor AMD RYZEN 5 1600 3.20 GHz, 8GB, 1TB, DVD-RW, nVIDIA GeForce GTX 1050 Ti 4GB, Endless OS, Mouse + Tastatura</h1>
  ...
  <div class="mySlides fade">
    ...
    <img src="imaginiPCAcer/produs3/1.jpg" style="width:100%">

  </div>

  <div class="mySlides fade">
    <div class="numbertext">2 / 3</div>
    <img src="imaginiPCAcer/produs3/2.jpg" style="width:100%">

  </div>

  <div class="mySlides fade">
    <div class="numbertext">3 / 3</div>
    <img src="imaginiPCAcer/produs3/3.jpg" style="width:100%">
...
<br>
      ...
      <td class="text-left">396.4 mm</td>
      </tr>
      <tr>
      <td class="text-left">Adancime</td>
      <td class="text-left">175.5 mm</td>
      </tr>
    <tr>
      <td class="text-left">Inaltime</td>
      <td class="text-left">462.9 mm</td>
      </tr>
    <tr>
      <td class="text-left">Continut pachet</td>
      <td class="text-left">1 x Mouse<br>1 x Tastatura<br>1 x Desktop PC</td>
      </tr>
    <tr>
      ...
      <td class="text-left">Ryzen 5</td>
      </tr>
      <tr>
      <td class="text-left">Model procesor</td>
      <td class="text-left">1600</td>
      </tr>
      <tr>
    ...
    <tr>
      ...
      <tr>
        <td class="text-left">Producator</td>
        <td class="text-left">Acer</td>
        </tr>
    <tr>
      <td class="text-left">Socket procesor</td>
      <td class="text-left">AM4</td>
      </tr>
      <tr>
        <td class="text-left">Slot onboard</td>
        <td class="text-left">1 x PCIe 3.0 x16<br>1 x PCIe x1</td>
        </tr>
      <tr>
        <td class="text-left">Porturi Back Panel</td>
        <td class="text-left">4 x USB 2.0<br>2 x USB 3.1<br>1 x RJ 45<br>1 x Audio in<br>1 x Audio out</td>
    ...
    <td class="text-left">GTX 1050 Ti</td>
    </tr>
    <tr>
