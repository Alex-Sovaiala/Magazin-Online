...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Placa de sunet Asus XONAR_DG
</title>
  </head>
  <script>
	var slideIndex = 1;
...
<div id="wrapperhead">
  ...
  <br><br><br>
    ...
    <div id="wrapper">
    <h1 style="font-size:30px;font-weight:bold;padding-left:1.5em;padding-right:2em;padding-top:1em;" >Placa de sunet Asus XONAR_DG
</h1>
  ...
  <div class="mySlides fade">
    ...
    <img src="imaginiSun/produs2/1.jpg" style="width:100%">

  </div>

  <div class="mySlides fade">
    <div class="numbertext">2 / 3</div>
    <img src="imaginiSun/produs2/2.jpg" style="width:100%">
...
<br>
      ...
      <td class="text-left"class="table-hover" style="width:600px;">CMI8786</td>
      </tr>
	  <tr>
      <td class="text-left">Raport semnal/zgomot (dB)</td>
	  ...
	  <tr>
      <td class="text-left">Capabilitati</td>
      <td class="text-left">Output Signal-to-Noise Ratio (A-Weighted) (Front-out) : 105 dB<br>Input Signal-to-Noise Ratio (A-Weighted) : 103 dB<br>Output THD+N at 1kHz (Front-out) :</td>
      </tr>
      <tr>
      <td class="text-left">Conectori iesiri</td>
      <td class="text-left">3 x Jack 3.5 mm</td>
      </tr>
	  <tr>
      <td class="text-left">Conectori intrari</td>
      <td class="text-left">1 x Jack 3.5 mm<br>1 x SPDIF</td>
      </tr>
      <tr>
      <td class="text-left">Interfata</td>
      <td class="text-left">PCI</td>
      </tr>
	  <tr>
      <td class="text-left">Efecte sonore</td>
      <td class="text-left">Smart Volume Normalizer<br>
	  Xear 3D<br>
	  Magic Voice<br>
	  Karaoke Functions<br>
	  FlexBass™<br>
	  27 Environment Effects<br>
	  DS3D GX2.5<br>
	  VoiceFX<br></td>
      </tr>
	  <tr>
      <td class="text-left">Sistem de operare</td>
      <td class="text-left">Microsoft Windows 7<br>Microsoft Windows Vista</td>
      </tr>
