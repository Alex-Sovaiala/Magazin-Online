...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Solid State Drive (SSD) Teclast, 120GB, 2.5"</title>
  </head>
  <script>
	var slideIndex = 1;
...
<div id="wrapperhead">
  ...
  <br><br><br>
    ...
    <div id="wrapper">
    <h1 style="font-size:30px;font-weight:bold;padding-left:1.5em;padding-right:2em;padding-top:1em;" >Solid State Drive (SSD) Teclast, 120GB, 2.5"</h1>
  ...
  <div class="mySlides fade">
    ...
    <img src="imaginiSsd/produs3/1.jpg" style="width:100%">

  </div>

  <div class="mySlides fade">
    <div class="numbertext">2 / 3</div>
    <img src="imaginiSsd/produs3/2.jpg" style="width:100%">

  </div>

  <div class="mySlides fade">
    <div class="numbertext">3 / 3</div>
    <img src="imaginiSsd/produs3/3.jpg" style="width:100%">
...
<br>
	...
	<p style="margin-left:3.5em;">
		<h4 style="font-size:20px;margin-left:2.5em;">Inlocuirea unitatii de disc</h4><br>
		<p style="margin-left:3.5em;"><br>SSD este urmatoarea evolutie intre dispozitivele de stocare in masa.
		 Ele sunt mai rapide, mai silentioase si functioneaza la temperaturi mai
		 scazute decat hard disk-urile. Fara componente in miscare, SSD-urile sunt
		 si mai increzatori in predecesorii lor
		Desktop-uri si laptop-uri SSD Biwi de drive-urile creste dramatic timpul
		de raspuns al computerului, randul sau, mai repede, mai repede de pornire
		si aplicatii inchise mai repede.</p><br>
	<h4 style="font-size:20px;margin-left:2.5em;">Restaurati vechea masina</h4>
		<p style="margin-left:3.5em;">
		<br>SSD nu numai ca ajuta la cresterea productivitatii, ci si la revigorarea
		 masinilor vechi. Cu achizitiile SSD, puteti salva pretul pe un nou computer
		 prin revigorarea celui vechi.
		<br>De mare viteza, mai rapid mai mult de 300% mai mare decat un hard disk
		tipic, o noua generatie de tehnologie 3D NAND are interfata SATA3 SSD
		(6.0 Gbps), compatibil cu SATA2 (3.0 Gbps) interfata;
		<br>Performanta inalta, citire / scriere: 560/520 MB / s Timp de pornire:
		 In termen de 12 secunde de incarcare; Incarcarea rapida in timpul
		 redarii si deschiderea software-ului de ultima generatie (de exemplu
		 PS, AI); miscare linistita, fara zgomot; anti-soc;
		pornire mai rapida si de inchidere a cererii de incarcare si de raspuns,
		 nici un zgomot, reactii instant, peste 45x eficiente energetic decat o
		 unitate de utilizare tipic greu: Notebook, PC, masini de POS-uri, calculator
		 multifunctional, echipamente de publicitate, terminale de retea, computer de bord
		 , supraveghere video, stocare server, produse si echipamente medicale.
		Protejati-va datele de duritate ca hard disk-uri - nu exista mici parti
		 in miscare care sunt predispuse la deteriorari. Rezistent la impact cu
		 durabilitate dovedita. Sistem compatibil: seria Windows, seria Unix, seria
		 Linux, Mac si alte sisteme standard;
		<br>Carcasa metalica, compacta si subtire: grosime 7 mm, compatibila cu
		discul dur de 9 mm;</p><br>
