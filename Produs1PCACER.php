...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Sistem Desktop PC Gaming Acer N50-600 cu procesor Intel® Core™ i3-8100 3.60 GHz, Coffee Lake, 8GB, 1TB, DVD-RW, NVIDIA GeForce GTX 1050 Ti 4GB, Free DOS</title>
  </head>
  <script>
	var slideIndex = 1;
...
<div id="wrapperhead">
  ...
  <br><br><br>
    ...
    <div id="wrapper">
    <h1 style="font-size:30px;font-weight:bold;padding-left:1.5em;padding-right:2em;padding-top:1em;" >Sistem Desktop PC Gaming Acer N50-600 cu procesor Intel® Core™ i3-8100 3.60 GHz, Coffee Lake, 8GB, 1TB, DVD-RW, NVIDIA GeForce GTX 1050 Ti 4GB, Free DOS</h1>
  ...
  <div class="mySlides fade">
    ...
    <img src="imaginiPCAcer/produs1/1.jpg" style="width:100%">

  </div>

  <div class="mySlides fade">
    <div class="numbertext">2 / 2</div>
    <img src="imaginiPCAcer/produs1/2.jpg" style="width:100%">
...
<br>
      ...
      <td class="text-left">6 MB</td>
      </tr>

	  <tr>
      <td class="text-left">Tehnologie procesor</td>
      <td class="text-left">12 nm</td>
      </tr>
	  <tr>
      ...
      <tr>
        ...
        <td class="text-left">4 x USB 2.0<br>1 x USB 3.1<br>1 x RJ 45<br>
