...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Carcasa Segotep Racing, ATX Mid Tower, Negru
	</title>
  </head>
  <script>
	var slideIndex = 1;
...
<div id="wrapperhead">
  ...
  <br><br><br>
    ...
    <div id="wrapper">
    <h1 style="font-size:30px;font-weight:bold;padding-left:1.5em;padding-right:2em;padding-top:1em;" >Carcasa Segotep Racing, ATX Mid Tower, Negru</h1>
  ...
  <div class="mySlides fade">
    ...
    <img src="imaginiCarcase/produs2/1.jpg" style="width:100%">

  </div>

  <div class="mySlides fade">
    <div class="numbertext">2 / 3</div>
    <img src="imaginiCarcase/produs2/2.jpg" style="width:100%">

  </div>

  <div class="mySlides fade">
    <div class="numbertext">3 / 3</div>
    <img src="imaginiCarcase/produs2/3.jpg" style="width:100%">
...
<br>
	...
	<ul style="margin-left:3em;font-size:18px;">
		<li>interior vopsit negru</li>
		<li>2x5.25 (extern)</li>
		<li>1x5.25 (intern)</li>
		<li>3x3.5 (intern)</li>
		<li>1x2.5 (intern)</li>
		<li>fata 1x 120mm fan (optional), spate 1x 80mm fan (inclus) sau 1x 92mm fan (optional), lateral 1x 120/140mm fan (optional)</li>
		<li>1x USB 3.0</li>
		<li>2x USB 2.0</li>
		<li>HD Audio</li>
		<li>sloturi expansiune: x7</li>
	</ul>
	<br>
      ...
      <tbody >
      <tr>
      <td class="text-left"class="table-hover" style="width:150px;">Culoare:</td>
      <td class="text-left"class="table-hover" style="width:600px;">Negru</td>
      </tr>
      <tr>
      <td class="text-left">Numar ventilatoare:</td>
      <td class="text-left">1 x 80 mm(inclus, spate)<br>1 x 120 mm(optional, fata)<br>1 x 120/140 mm(optional, lateral)<br>1 x 92 mm(optional, spate)</td>
      </tr>
      <tr>
      <td class="text-left">Deschidere laterala</td>
      <td class="text-left">Da</td>
      </tr>
	  <tr>
      <td class="text-left">Ventilatoare incluse</td>
      <td class="text-left">1</td>
      </tr>
      <tr>
      <td class="text-left">Format</td>
      <td class="text-left">Micro ATX<br>	ATX</td>
      </tr>
      <tr>
      ...
      <tr>
      <td class="text-left">Numar locase fixe externe</td>
      <td class="text-left">2 x 5.25"</td>
      </tr>
      <tr>
      <td class="text-left">Numar locase fixe interne</td>
      <td class="text-left">3 x 3.5"<br>1 x 2.5"<br>	1 x 5.25"</td>
      </tr>
      <tr>
      <td class="text-left">Numar locase sloturi extensii</td>
      <td class="text-left">7</td>
      </tr>
      <tr>
      <td class="text-left">Altele</td>
      <td class="text-left">2 x USB2.0 <br> 1 x USB 3.0<br>HD Audio</td>
      </tr>
      <tr>
      <td class="text-left">Dimensiuni (W x H x D mm)</td>
      <td class="text-left">190 x 407 x 428</td>
      </tr>
