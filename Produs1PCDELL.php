...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Sistem Desktop Dell OptiPlex 3060 MT cu procesor Intel® Core™ i5-8500 pana la 4.10 GHz, Coffee Lake, 8GB, 256GB SSD, Intel UHD Graphics 630, Microsoft Windows 10 Pro, Black</title>
  </head>
  <script>
	var slideIndex = 1;
...
<div id="wrapperhead">
  ...
  <br><br><br>
    ...
    <div id="wrapper">
    <h1 style="font-size:30px;font-weight:bold;padding-left:1.5em;padding-right:2em;padding-top:1em;" >Sistem Desktop Dell OptiPlex 3060 MT cu procesor Intel® Core™ i5-8500 pana la 4.10 GHz, Coffee Lake, 8GB, 256GB SSD, Intel UHD Graphics 630, Microsoft Windows 10 Pro, Black</h1>
  ...
  <div class="mySlides fade">
    ...
    <img src="imaginiPCDell/produs1/1.jpg" style="width:100%">

  </div>

  <div class="mySlides fade">
    <div class="numbertext">2 / 2</div>
    <img src="imaginiPCDell/produs1/2.jpg" style="width:100%">
...
<td class="text-left">154 mm</td>
</tr>
<tr>
<td class="text-left">Adancime</td>
<td class="text-left">274 mm</td>
</tr>
<tr>
<td class="text-left">Inaltime</td>
<td class="text-left">350 mm</td>
</tr>
<tr>
