...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Televizor LED Smart Android Philips, 139 cm, 55PUS7303/12, 4K Ultra HD</title>
  </head>
  <script>
	var slideIndex = 1;
...
<div id="wrapperhead">
  ...
  <br><br><br>
    ...
    <div id="wrapper">
    <h1 style="font-size:30px;font-weight:bold;padding-left:1.5em;padding-right:2em;padding-top:1em;" >Televizor LED Smart Android Philips, 139 cm, 55PUS7303/12, 4K Ultra HD</h1>
  ...
  <div class="mySlides fade">
    ...
    <img src="imaginiTvPhilips/produs1/1.jpg" style="width:100%">

  </div>

  <div class="mySlides fade">
    <div class="numbertext">2 / 6</div>
    <img src="imaginiTvPhilips/produs1/2.jpg" style="width:100%">

  </div>

  <div class="mySlides fade">
    <div class="numbertext">3 / 6</div>
    <img src="imaginiTvPhilips/produs1/3.jpg" style="width:100%">

  </div>
  <div class="mySlides fade">
    <div class="numbertext">4 / 6</div>
    <img src="imaginiTvPhilips/produs1/4.jpg" style="width:100%">

  </div>
  <div class="mySlides fade">
    <div class="numbertext">5 / 6</div>
    <img src="imaginiTvPhilips/produs1/5.jpg" style="width:100%">

  </div>
  <div class="mySlides fade">
    <div class="numbertext">6 / 6</div>
    <img src="imaginiTvPhilips/produs1/6.jpg" style="width:100%">
</div>
...
1 x Audio in</td>
    ...
    <tr>
      ...
      <td class="text-left">1244 x 781 x 266 mm</td>
    </tr>
    <tr>
      <td class="text-left">Putere consumata</td>
      <td class="text-left">86 W</td>
    </tr>
    <tr>
